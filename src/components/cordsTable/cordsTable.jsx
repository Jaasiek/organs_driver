...
const CordsTable = forwardRef(function CordsTable({ creating }, ref, step) {
  ...
  useEffect(() => {
    const handleCordsActivation = (data) => {
      if (data.step === step && data.success === true) {
  ...
  return (
    <div className="cordsTable">
      <div className="cords" id="pedal">
        ...
        <div
          className={`cord ${
            activeCords.includes(1) || creatingCords.includes(1) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(2) || creatingCords.includes(2) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(3) || creatingCords.includes(3) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(4) || creatingCords.includes(4) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(5) || creatingCords.includes(5) ? "active" : ""
          }`}
      ...
      <div className="cords" id="manualST">
        ...
        <div
          className={`cord ${
            activeCords.includes(6) || creatingCords.includes(6) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(7) || creatingCords.includes(7) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(8) || creatingCords.includes(8) ? "active" : ""
          }`}
        ...
        <div
          className={`cord ${
            activeCords.includes(9) || creatingCords.includes(9) ? "active" : ""
          }`}
